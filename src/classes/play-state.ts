...
class PlayState {
    ...
    constructor(game: boldInvaders,
        ...
        playStateOptions: BoldInvaders.PlayState) {

    }

    enter(game: boldInvaders,
        playerOptions: BoldInvaders.Player,
        enemyOptions: BoldInvaders.Enemy,
        playStateOptions: BoldInvaders.PlayState) {
        ...
        for (var rank = 0; rank < enemyOptions.invaderRanks; rank++) {
            for (var file = 0; file < enemyOptions.invaderFiles; file++) {
                var invader: BoldInvaders.Invader = {x: (game.stateOptions.width / 2) + ((enemyOptions.invaderFiles / 2 - file) * 200 / enemyOptions.invaderFiles),
